...
Strategys::Strategys(int strategy){
...
void Strategys::theFirstStrat(){
	//Statistically the best possible buildOrder.

	strategyQueue = { probe, probe, probe, pylon, probe, probe, assimilator, probe, gasworkerRequest, gasworkerRequest, gasworkerRequest,
		probe, pylon, probe, forge, cannon, gateway, cannon, cannon, cannon, probe,
		cybercore, probe, probe, probe, pylon, cannon, citadel, probe, probe, probe, pylon, cannon, archives, probe, probe, pylon, pylon, dtemplar, dtemplar, dtemplar, dtemplar, dtemplar, dtemplar };
